...
// Route for hosts to accept/reject booking status (Disabled: auto-confirmed on payment)
// router.post("/:bookingId/status", isLoggedIn, wrapAsync(bookingController.updateBookingStatus));

// Route for guests to cancel bookings (Disabled to prevent refunds)
...
// Route to retry payment (Disabled to remove pay later feature)
